...
namespace Kaleva\Application;

use Doctrine\ORM\EntityManager;
use Kaleva\Entities\BaseEntity;

/**
 * @property-read \Doctrine\ORM\EntityManager $entityManager
 * @property-read \Doctrine\ORM\EntityRepository $page
 * @property-read \Kaleva\Repositories\UserRepository $user
 * ...
 *
...
class DatabaseManager {
	...
	public function __get($name) {
		if ($name == 'entityManager') {
			...
			return $this->entityManager->getRepository('School\\Entities\\' . ucfirst($name));
		}
	}
